...
class Trainer():
    ...
    ckpt_denoiser_step: int = 192000
    ckpt_initp_step: int = 192000
    #ckpt_denoiser: str = f'/home/m6744/ckpts/07312023_220156/ckpt_denoiser_{ckpt_denoiser_step}.pt'
    ckpt_denoiser: str = f'/scratch/mr6744/pytorch/ckpts/08022023_033048/ckpt_denoiser_{ckpt_denoiser_step}.pt'
    #ckpt_initp: str = f'/home/mr6744/ckpts/07312023_220156/ckpt_initp_{ckpt_initp_step}.pt'
    ckpt_initp: str = f'/scratch/mr6744/pytorch/ckpts/08022023_033048/ckpt_initp_{ckpt_initp_step}.pt'
...
def ddp_setup(rank, world_size):
    ...
    os.environ["MASTER_PORT"] = "12349" # any free port on machine
