...
class Trainer():
    ...
    checkpoint_init_epoch: int = 3300
    ...
    checkpoint_init: str = f'/scratch/mr6744/pytorch/checkpoints_init_predictor/06272023_192601//checkpoint_initpr_{checkpoint_init_epoch}.pt'
...
def main(rank: int, world_size:int):
    ...
    if trainer.wandb and rank == 0:
        ...
        wandb.init(
            project="deblurring",
            name=f"conditioned with pretrained init",
            config=
            {
            "GPUs": world_size,
