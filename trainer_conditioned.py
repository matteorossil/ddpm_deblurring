...
class Trainer():
    ...
    def init(self):
        ...
        self.data_loader_val = DataLoader(dataset=Data(path=self.dataset, mode="val", size=(self.image_size,self.image_size)), batch_size=self.n_samples, num_workers=2, drop_last=True, shuffle=False, pin_memory=True)
