...
class Trainer():
    ...
    def __init__(self, argv):
        ...
        self.ckpt_denoiser: str = f'/home/m6744/ckpts/{argv.ckpt_step}/ckpt_denoiser_{self.ckpt_step}.pt'
        #self.ckpt_denoiser: str = f'/scratch/mr6744/pytorch/ckpts/{argv.ckpt_step}/ckpt_denoiser_{self.ckpt_step}.pt'
        self.ckpt_initp: str = f'/home/mr6744/ckpts/{argv.ckpt_step}/ckpt_initp_{self.ckpt_step}.pt'
