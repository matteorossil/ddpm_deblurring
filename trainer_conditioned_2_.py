...
class Trainer():
    ...
    ckpt_denoiser_step: int = 1_240_000
    ckpt_initp_step: int = 1_240_000
    #ckpt_denoiser: str = f'/home/mr6744/ckpts/08012023_190906/ckpt_denoiser_{ckpt_denoiser_step}.pt'
    ckpt_denoiser: str = f'/scratch/mr6744/pytorch/ckpts/06312023_000000/ckpt_denoiser_{ckpt_denoiser_step}.pt'
    #ckpt_initp: str = f'/home/mr6744/ckpts/08012023_190906/ckpt_initp_{ckpt_initp_step}.pt'
    ckpt_initp: str = f'/scratch/mr6744/pytorch/ckpts/06312023_000000/ckpt_initp_{ckpt_initp_step}.pt'
    ...
    def run(self):
        ...
        for epoch in range(self.epochs):
            ...
            if (self.step == 0) and (self.gpu_id == 0):
                ...
                sample_steps.append(self.step + self.ckpt_denoiser_step + 490_000)
...
def ddp_setup(rank, world_size):
    ...
    os.environ["MASTER_PORT"] = "12361" # any free port on machine
