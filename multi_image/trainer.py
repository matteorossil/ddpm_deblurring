...
class Trainer():
    ...
    ckpt_denoiser_step: int = 920000
    ckpt_initp_step: int = 920000
    #ckpt_denoiser: str = f'/home/mr6744/ckpts/07272023_182450/ckpt_denoiser_{ckpt_denoiser_step}.pt'
    ckpt_denoiser: str = f'/scratch/mr6744/pytorch/ckpts/08022023_100900/ckpt_denoiser_{ckpt_denoiser_step}.pt'
    #ckpt_initp: str = f'/home/mr6744/ckpts/07272023_182450/ckpt_initp_{ckpt_initp_step}.pt'
    ckpt_initp: str = f'/scratch/mr6744/pytorch/ckpts/08022023_100900/ckpt_initp_{ckpt_initp_step}.pt'
