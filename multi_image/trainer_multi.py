...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_t', type=str, default="gopro_small_multi")
    parser.add_argument('--dataset_v', type=str, default="gopro_small_multi")
    parser.add_argument('--ckpt_step', type=int, default=0)
    parser.add_argument('--ckpt_path', type=str, default="")
    parser.add_argument('--num_workers', type=int, default=8)
    parser.add_argument('--multiplier', type=int, default=1_000)
    parser.add_argument('--sampling_interval', type=int, default=12_500)
